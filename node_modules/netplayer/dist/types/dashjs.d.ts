declare namespace DashJS {
    ...
    interface ProtectionData {
         ...
         */
        serverURL?: string | {
            [P in MediaKeyMessageType]: string;
        };
    ...
    type TrackSelectionMode = 'highestSelectionPriority' | 'highestBitrate' | 'firstTrack' | 'highestEfficiency' | 'widestRange';
